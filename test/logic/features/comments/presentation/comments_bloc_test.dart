...
void main() {
  ...
  group('GetComments', () {
    Future<Either<Failure, List<Comment>>> useCaseCall() => mockGetComments(PostParams(post: tPost));
  ...
  group('CommentLikePressed', () {
    ...
    Future<Either<Failure, Comment>> useCaseCall() => mockToggleLike(CommentParams(comment: tTargetComment));
