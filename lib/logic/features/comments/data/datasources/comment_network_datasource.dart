...
abstract class CommentNetworkDataSource {
  ...
  Future<CommentModel> addPostComment(PostModel post, NewCommentValue newComment);
...
class CommentNetworkDataSourceImpl implements CommentNetworkDataSource {
  ...
  @override
  Future<CommentModel> addPostComment(PostModel post, NewCommentValue newComment) async {
